...
REM Created on 2019/11/25 14:05:40
REM ###########################################################################
...
set FPR="Fortifyspring-generic-server.fpr"
set BUILDID="spring-generic-server"
set ARGFILE="Fortifyspring-generic-server.bat.args"
set BYTECODE_ARGFILE="Fortifyspring-generic-server.bat.bytecode.args"
set MEMORY=-Xmx14636M -Xms400M -Xss24M 
set LAUNCHERSWITCHES=""
set OLDFILENUMBER=Fortifyspring-generic-server.bat.fileno
set FILENOMAXDIFF=10
set ENABLE_BYTECODE=false

set PROJECTROOT0="C:\Dev\hpaa-octane-dev\work\workspace\spring-generic-server"
...
REM ###########################################################################
echo Starting scan
%SOURCEANALYZER% %MEMORY% %LAUNCHERSWITCHES% -b %BUILDID% -scan -Xmx16G -f %FPR%
IF %ERRORLEVEL%==1 (
echo Sourceanalyzer failed, exiting
GOTO :FINISHED
)
...
:FINISHED
REM ARGS "-cp"
REM ARGS "PROJECTROOT0_MARKER\.mvn\wrapper\maven-wrapper.jar"
REM ARGS "-source"
REM ARGS "1.8"
